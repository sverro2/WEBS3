...
$(document).ready(function(){
	...
	$('#addLocation').click(function(event) {
  	...
  	function animateLocationPane(){
  		var $lefty = $("#locationeditor");
	    $lefty.animate({
	...
	<div class="content">
		...
		<div class="row">
			<div class="col-md-12 contentbox">
				<div class="header">
					<div>Locaties</div>
					<div><a href="#"><span class="glyphicon glyphicon-plus" id="addLocation"></span></a></div>
				</div>
				<div class="panel panel-default">
					...
					$event_table_content = array(
						"Event" => "{name}",
						"Adres" => "{address}",
						"Edit" => "<span class='glyphicon glyphicon-wrench' data-locationId='{id}'></span>,#",
						"Remove" => "<span class='glyphicon glyphicon-remove' data-locationId='{id}'></span>,#"
					);
